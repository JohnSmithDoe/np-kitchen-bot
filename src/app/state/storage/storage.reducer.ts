...
export const storageReducer = createReducer(
  ...
  on(StorageActions.addCategory, (state, { category }) => ({ ...state, categories: addListCategory(state.categories, category),})),
  on(StorageActions.removeCategory, (state, { category }) => ({ ...state, categories: removeListCategory(state.categories, category),})),
